...
# gm[['Open', 'MA50', 'MA200']].plot(label='GM', figsize=(12,6))
#
# plt.show()
...
#
# scatter_matrix(car_comp, figsize=(6,6), alpha=0.2, hist_kwds={'bins':50})
# plt.show()
...
tesla['Cumulative Return'].plot(label='Tesla', figsize=(12,6))
